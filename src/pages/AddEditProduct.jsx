...
const AddEditProduct = () => {
 ...
 <div>
  ...
  <textarea  placeholder="Describe the material, fit, and unique features..."
    rows={4}  className="border rounded-lg p-2.5 text-sm w-full mt-1 outline-none focus:ring-1 focus:ring-[#C2863FFF] resize-none"/>
</div>
</div>
<div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mb-6">
  <div className="bg-white rounded-2xl shadow-sm border p-4 md:p-6">
    <div className="flex items-start gap-3 mb-5">
      ...
      <div>
        <h2 className="font-semibold text-sm md:text-base">Pricing</h2>
        <p className="text-xs text-gray-500">
  ...
  <div className="bg-white rounded-2xl shadow-sm border p-4 md:p-6">
    <div className="flex items-start gap-3 mb-5">
      ...
      <div>
        <h2 className="font-semibold text-sm md:text-base">Inventory</h2>
        <p className="text-xs text-gray-500">
    ...
    <div className="bg-gray-50 border rounded-xl p-3 flex items-center justify-between">
      ...
      <div onClick={() => setLowStock(!lowStock)}
        ...
        <div className={`bg-white w-4 h-4 rounded-full shadow transform transition ${
            lowStock ? "translate-x-5" : "translate-x-0"
          }`}/>
      </div>
    </div>
  </div>
...
<div className="bg-white rounded-2xl shadow-sm border p-4 md:p-6 mb-6">
  ...
  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
    <div className="md:col-span-2 border-dashed border rounded-xl p-6 flex flex-col items-center justify-center text-center bg-gray-50">
      <img src={uploadIcon} className="h-6 mb-2 opacity-70" />
  ...
  <div className="flex gap-3 mt-5 flex-wrap">
    <div className="relative">
      ...
      <span className="absolute top-0 left-0 bg-[#C2863FFF] text-white text-[10px] px-1 rounded-br">
        MAIN
      </span>
    </div>
    <img src={d4} className="h-16 w-16 rounded-lg object-cover" />
    <div className="h-16 w-16 border-dashed border rounded-lg flex items-center justify-center">
      <img src={addIcon} className="h-5 opacity-70" />
    </div>
  </div>
</div>
<div className="bg-white rounded-2xl shadow-sm border p-4 md:p-6 flex flex-col md:flex-row justify-between items-center gap-4">
  ...
  <div className="flex items-center gap-3 bg-gray-50 border px-3 py-2 rounded-xl">
    <div>
